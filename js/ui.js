...
ZenPen.ui = (function() {
	...
	function bindElements() {
		...
		if (firebase) {
			loadElement = document.querySelector( '.load' );
			loadElement.onclick = onLoadClick;
			document.querySelector('.loadbutton').onclick = loadArticle;
		}
		...
		loadModal = overlay.querySelector('.load-from-title');
